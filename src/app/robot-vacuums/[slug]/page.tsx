      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <Breadcrumbs
          items={[
            ...
            { label: article.title, href: `/robot-vacuums/${slug}` },
          ]}
        />
      </div>
      ...
      <section className="bg-blue-50 border-y border-blue-200 py-12 my-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Compare All Robot Vacuums
          </h2>
          <p className="text-gray-600 mb-6">
            See the full comparison table with all 13 robot vacuums, specs,
            prices, and detailed ratings.
          </p>
          <Link
            href="/robot-vacuums"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/robot-vacuums/lidar-vs-camera-navigation">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Compare navigation technologies and understand which mapping works best.
              </p>
            </div>
          </Link>
          ...
          <Link href="/robot-vacuums/best-robot-vacuums-under-500">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Find the best budget and mid-range robot vacuums with honest trade-offs.
              </p>
            </div>
          </Link>
          ...
          <Link href="/robot-vacuums/self-emptying-robot-vacuums-worth-it">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Analyze whether self-emptying bases justify the premium cost.
              </p>
            </div>
          </Link>
          ...
          <Link href="/robot-vacuums/robot-vacuum-mop-combo-guide">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Evaluate whether combos effectively mop or if they're a gimmick.
              </p>
            </div>
          </Link>
        </div>

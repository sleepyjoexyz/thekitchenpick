...
export const mockDeals: Deal[] = [
  ...
  {
    id: 'RV-004',
    title: 'ECOVACS DEEBOT T30S Robot Vacuum and Mop, 11000Pa, ZeroTangle',
    category: 'Robot Vacuums',
    source: 'Amazon',
    amazonUrl: 'https://www.amazon.com/dp/B0D1FLHMD4?tag=rogeti02-20',
    imageUrl: 'https://m.media-amazon.com/images/I/7185-GwFTlL._AC_SL1500_.jpg',
    timeLeft: 'Limited Time Deal',
    imageAlt: 'ECOVACS DEEBOT T30S Robot Vacuum',
    coupon: '',
  },
  {
    id: 'RV-005',
  ...
  {
    id: 'SC-002',
    title: 'Baseus X1 Pro Dual-Tracking Solar Security Camera',
    category: 'Security Cameras',
    source: 'Amazon',
